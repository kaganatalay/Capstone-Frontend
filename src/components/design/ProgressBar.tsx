  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          width: mounted ? `${pct}%` : "0%",
          background: "linear-gradient(90deg, oklch(0.38 0.14 10), oklch(0.50 0.14 10))",
      ...
      >
        ...
        <span
          ...
          style={{
            ...
            height: 8,
            borderRadius: "50%",
            background: "oklch(0.50 0.14 10)",
            boxShadow:
              "0 0 6px 3px oklch(0.38 0.14 10 / 0.5), 0 0 14px 6px oklch(0.38 0.14 10 / 0.25)",
            opacity: pct > 2 ? 1 : 0,
