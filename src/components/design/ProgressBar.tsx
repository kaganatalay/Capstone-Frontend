  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          width: mounted ? `${pct}%` : "0%",
          background: "linear-gradient(90deg, oklch(0.72 0.14 75), oklch(0.88 0.16 82))",
      ...
      >
        ...
        <span
          ...
          style={{
            ...
            height: 8,
            borderRadius: "50%",
            background: "oklch(0.92 0.18 82)",
            boxShadow:
              "0 0 6px 3px oklch(0.82 0.14 75 / 0.7), 0 0 14px 6px oklch(0.82 0.14 75 / 0.35)",
            opacity: pct > 2 ? 1 : 0,
